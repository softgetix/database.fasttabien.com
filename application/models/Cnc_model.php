...
class Cnc_model extends CI_Model {
    ...
    public function getData($tablename, $select = '*', $where = false, $join = false, $order_by = false, $order = 'DESC', $limit = false, $offset = false, $or_like = false,$group_by = false) {
        ...
        public function getDatanew($tablename, $select = '*', $where = false, $order_by = false, $order = 'DESC', $limit = false, $offset = false, $or_like = false,$group_by = false) {
    ...
    public function getRowCountnew($tablename, $select = '*', $where = false, $order_by = false, $order = 'desc', $or_like = false) {
