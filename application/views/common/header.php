...
<div class="page-header -i navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			...
			<img src="<?php echo base_url() ?>assets/img/admin-logo.png" alt="logo" class="logo-default"/>
			</a>
			...
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown dropdown-user">
					...
					<span class="username username-hide-on-mobile">
						<strong><?php echo ucfirst($this->session->userdata('name'));?></strong>
							 &nbsp;(<?php echo trim($this->session->userdata('role'));?>)
					</span>
